...
const AdminDashboard = ({ children }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-950 md:transition-colors w-full  relative text-slate-700 dark:text-slate-300 min-h-screen" >
            <div className="fixed top-0 left-0 w-full z-40 bg-white dark:bg-slate-950 border-b dark:border-slate-800 border-slate-200 md:transition-colors" >
            ...
            <div className="py-24 px-4 md:px-10 max-w-screen-xl mx-auto" >{children}</div>
        </div>
    )
}
