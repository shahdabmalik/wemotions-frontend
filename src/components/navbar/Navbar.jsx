...
const Navbar = ({ children }) => {
    ...
    return (
        <>
            <div className={"fixed z-50 top-0 left-0 w-full border-b border-slate-300 dark:border-slate-800  transition-transform md:transition-all duration-300 ease-linear backdrop-blur-sm bg-white dark:bg-slate-950 bg-opacity-50 dark:bg-opacity-75 " + (show ? " translate-y-0 " : " -translate-y-32 ") + (shadow ? " shadow-md " : " ")} >
