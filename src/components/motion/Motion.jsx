        ...
        <div className={" border shadow-lg rounded-md relative md:transition-colors dark:bg-black px-2 sm:px-3 pt-1.5 pb-2.5 " + (localMotion?.aiScore <= 25 ? "border-red-600" : localMotion?.aiScore > 25 && localMotion?.aiScore < 50 ? "border-orange-400" : localMotion?.aiScore >= 50 && localMotion?.aiScore < 75 ? "border-amber-300" : "border-green-500")} >
            ...
            <div className=" mt-1 xs:mt-2 flex flex-col gap-1.5 xs:flex-row items-center justify-between text-xs w-full dark:text-slate-100 font-inter" >
                <div className="flex justify-between xs:justify-normal gap-5 items-center w-full xs:w-auto" >
                    <p className={"capitalize flex items-center gap-1 font-medium " + (localMotion?.aiScore <= 25 ? "text-red-600" : localMotion?.aiScore > 25 && localMotion?.aiScore < 50 ? "text-orange-500" : localMotion?.aiScore >= 50 && localMotion?.aiScore < 75 ? "text-amber-500 dark:text-amber-300 " : "text-green-600 dark:text-green-400")} >A.I Score: <span className={" "} >{localMotion?.aiScore}</span></p>
