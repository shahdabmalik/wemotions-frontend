    ...
    return (
        <div className="border-2 dark:border-slate-700 shadow-lg p-3 rounded-md" >
            <div className="flex gap-4 items-center" >
                ...
                <Link to={`/${page?.slug}`} className="capitalize text-2xl font-bold font-inter text-blue-700 dark:text-blue-500 hover:underline underline-offset-4" >{page?.name}</Link>
            </div>
