...
const PageCard = ({ page }) => {
    return (
        <div className="border dark:border-slate-800 shadow-lg p-3 rounded-md md:transition-colors" >
            <div className="flex gap-4 items-center" >
                <div className="w-12 h-12 rounded-full bg-slate-200 dark:bg-slate-800 md:transition-colors"></div>
